...
import com.sovize.ultracop.views.fragments.ReportAdminFragment
...
class ReportDetail : AppCompatActivity() {
    ...
    private lateinit var adminFragment: ReportAdminFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent?.let {
            ...
            cUser = it.extras?.getParcelable(AppKey.userparcel) ?: User()
        }

        savedInstanceState?.let {
            report = it.getParcelable("KEY") ?: AccidentReport()
            cUser = it.getParcelable(AppKey.userparcel) ?: User()
        }
        ...
        if (cUser.permission.contains("g")) {
            adminFragment = ReportAdminFragment.newInstance(report)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelable(AppKey.userparcel, cUser)
    }
